...
const output = {
  ...
  scope: "Europe P0 unresolved records after ready batches 9–13",
...
const outputPath = path.join(root, "data/candidate-priority-p0-europe-unresolved-after-batch-13-2026-09-03.json");
