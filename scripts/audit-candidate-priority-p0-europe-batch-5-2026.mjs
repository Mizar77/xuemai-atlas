...
const modulePath = path.join(root, "app/candidate-priority-p0-europe-batch-5-2026.ts");
const bundlePath = "/private/tmp/candidate-p0-europe-batch-5-2026.mjs";
...
const allowedExternalEndpoints = new Set(["kathleen-mckeown-us"]);

if (people.length !== 6) errors.push(`expected 6 people, got ${people.length}`);
