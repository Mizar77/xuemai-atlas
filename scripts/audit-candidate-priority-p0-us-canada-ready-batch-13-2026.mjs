...
const input = path.join(root, "app/candidate-priority-p0-us-canada-ready-batch-13-2026.ts");
const output = "/private/tmp/candidate-p0-usca-batch-13-audit.mjs";
...
const primary = mod.candidatePriorityP0UsCanadaReadyBatch13People2026;
const errors = [];
...
console.log(`US/Canada P0 batch 13 audit PASS: ${primary.length} primary, ${mod.relationships.length} relationships, ${mod.placements.length} placements, ${mod.groupMembers.length} group members`);
