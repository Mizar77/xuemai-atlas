...
const bundle = "/private/tmp/candidate-p0-europe-batch-15-2026.mjs";
execFileSync(path.join(root, "node_modules/.bin/esbuild"), [path.join(root, "app/candidate-priority-p0-europe-batch-15-2026.ts"), "--bundle", "--platform=node", "--format=esm", `--outfile=${bundle}`], { stdio: "ignore" });
...
if (primary.length !== 7 || rosterPromotions.length !== 7) errors.push("expected 7 primary people/promotions");
