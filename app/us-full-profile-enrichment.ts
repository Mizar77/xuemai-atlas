...
export const usFullProfileEnhancements: Record<string, PersonEnhancement> = {
  ...
  "christopher-potts-us": enhance(potts, "Stanford 语言学教授兼系主任，连接形式语义、语用学与计算语言学。", ["Yale PhD", "Semantics", "Pragmatics", "Stanford NLP"], [["教育", "Yale Linguistics 博士"], ["任职", "Stanford Linguistics Professor and Chair"], ["研究主线", "语义、语用、语言推理与计算建模"]]),
  ...
  "he-he-us": enhance(hehe, "NYU 副教授，研究交互式学习、自然语言生成和负责任 AI。", ["Stanford PhD", "NYU", "Interactive Learning", "Responsible AI"], [["教育", "Stanford 计算机科学博士"], ["任职", "NYU Computer Science and Center for Data Science faculty"], ["研究主线", "交互式学习、自然语言生成和负责任语言技术"]]),
