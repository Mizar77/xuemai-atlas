...
const description = "探索中国大陆、香港、新加坡与美国 AI、NLP、计算机视觉、多模态与机器人学者的师承、合作、研究群落与人才流向。关系与职业信息均附可追溯来源。";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "zh_CN",
    url: siteUrl,
    images: [{ url: socialImageUrl, width: 1728, height: 910, alt: "学脉 Atlas — 中国大陆、香港、新加坡与美国 AI / NLP / CV 学术关系图谱" }],
  },
