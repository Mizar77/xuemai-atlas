...
export const fourRegionProfileRelationships: Relationship[] = [
  ...
  { id: "luu-barzilay-postdoc", from: "anh-tuan-luu", to: "anh-tuan-luu", type: "talent", subtype: "postdoc_mentor", label: "MIT CSAIL 博士后导师：Regina Barzilay", evidence: "个人主页记录其 2018–2020 年在 MIT CSAIL 从事博士后研究，由 Regina Barzilay 指导。", source: anhTuanPersonal, verified: true },
