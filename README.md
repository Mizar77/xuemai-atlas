...
当前版本覆盖**中国大陆、香港与新加坡的 AI、NLP 与 LLM 学术生态**。中国大陆第一期包括清华、北大、复旦、人大、哈工大、中科院自动化所、南京大学与上海交大；香港包括 HKU、HKUST、CUHK、CityU、PolyU 与 HKBU；新加坡包括 NUS、NTU、SUTD、SMU 与 A\*STAR。大陆范围较大，网页会明确标出第一期覆盖边界，并持续按机构名录补充。
...
The atlas currently covers the **AI, NLP, and LLM ecosystems in Mainland China, Hong Kong, and Singapore**. The first Mainland China release includes Tsinghua, Peking University, Fudan, Renmin University, Harbin Institute of Technology, CAS Institute of Automation, Nanjing University, and Shanghai Jiao Tong University. Hong Kong includes HKU, HKUST, CUHK, CityU, PolyU, and HKBU; Singapore includes NUS, NTU, SUTD, SMU, and A\*STAR. Because Mainland China is much larger, the site labels this as a phase-one boundary and will continue auditing institution rosters.
